...
function isOverElement(elem, x, y) {
...
function handleBodyPointerdown (event) {
  ...
  const menu = document.querySelector('div.popup div.menu');

  if (!isOverElement(btn, event.clientX, event.clientY) &&
    !isOverElement(menu, event.clientX, event.clientY)) {
...
window.addEventListener("load", (event) => {
  ...
  document.documentElement.addEventListener('pointerdown', handleBodyPointerdown, true);
